...
class DefaultDataHelper {
  static List<ProductModel> getDefaultPakistaniProducts() {
    final List<Map<String, dynamic>> rawData = [
      ...
      {'name': 'Nivea Soft Moisturizing Cream 100ml', 'price': 650.0, 'cost': 600.0},
      {'name': 'Olay Natural White Cream 50g', 'price': 950.0, 'cost': 900.0},
      {'name': 'Garnier Light Complete Face Wash 100g', 'price': 450.0, 'cost': 410.0},
      ...
      {'name': 'Veet Hair Removal Cream Normal 25g', 'price': 220.0, 'cost': 200.0},

      // Hair Care
      {'name': 'Sunsilk Black Shine Shampoo 200ml', 'price': 450.0, 'cost': 420.0},
      {'name': 'Dove Intense Repair Shampoo 200ml', 'price': 550.0, 'cost': 510.0},
      {'name': 'Pantene Pro-V Shampoo 200ml', 'price': 500.0, 'cost': 470.0},
      {'name': 'Head & Shoulders Anti-Dandruff 200ml', 'price': 600.0, 'cost': 560.0},
      ...
      {'name': 'Always Ultra Sanitary Pads (Large)', 'price': 450.0, 'cost': 420.0},
      {'name': 'Pampers Baby Dry Size 4', 'price': 2800.0, 'cost': 2600.0},
      {'name': 'Colgate Toothpaste Maximum Cavity 120g', 'price': 250.0, 'cost': 230.0},
      {'name': 'Sensodyne Fluoride Toothpaste 100g', 'price': 650.0, 'cost': 600.0},
      ...
      {'name': 'Bonus Tristar Washing Powder 1Kg', 'price': 450.0, 'cost': 420.0},
      ...
      {'name': 'Dettol Liquid Surface Cleaner 500ml', 'price': 600.0, 'cost': 560.0},
      {'name': 'Mortein Mosquito Repellent Coil', 'price': 120.0, 'cost': 105.0},
      ...
      {'name': 'Mitchells Chilli Garlic Sauce 800g', 'price': 460.0, 'cost': 420.0},
